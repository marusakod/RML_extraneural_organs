...
```{r get_ME_signif_boxplots}
ME_signif_box_orange = make_disease_stage_boxplots_for_modules(Module = 'orange', MEs_w_meta = meta_w_MEs$muscle, ME_signif = all_ME_signif$muscle)
ME_signif_box_darkgeen = make_disease_stage_boxplots_for_modules(Module = 'darkgreen', MEs_w_meta = meta_w_MEs$muscle, ME_signif = all_ME_signif$muscle) 
...
# ME signif boxplots
ggsave(file.path(out_dir, 'orange_ME_signif_boxplot.svg'), ME_signif_box_orange, width = 1.6, height = 3.3)
ggsave(file.path(out_dir, 'darkgeen_ME_signif_boxplot.svg'), ME_signif_box_darkgeen, width =1.6 , height = 3.3)
