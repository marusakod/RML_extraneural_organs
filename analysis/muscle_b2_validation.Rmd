...
orange_hub_overlap = m_b1_b2_hub_stats_merged %>% filter(module == 'orange', is.hub_b1_MM == TRUE , is.hub_b2_MM == TRUE ) %>% pull(gene_symbol)
darkgreen_hub_overlap = m_b1_b2_hub_stats_merged %>% filter(module == 'darkgreen',  is.hub_b1_MM == TRUE , is.hub_b2_MM == TRUE ) %>% pull(gene_symbol)

orange_hub_labels_plot = hub_labels_plot(orange_hub_overlap)
darkgreen_hub_labels_plot = hub_labels_plot(darkgreen_hub_overlap)
...
# plot with hub genes overlaps (to be placed next to MM correlations plot)
ggsave(file.path(out_dir, 'orange_hub_overlap_plot.svg'), orange_hub_labels_plot, width = 2.5, height = 2 )
ggsave(file.path(out_dir, 'darkgreen_hub_overlap_plot.svg'), darkgreen_hub_labels_plot, width = 2.5 , height = 2)
